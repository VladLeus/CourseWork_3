...
const CartElemCard: React.FC<CartElemCardProps> = ({ carPart}) => {
    ...
    return (
        <div className="flex flex-col items-start justify-center w-[250px] rounded-2xl bg-white text-black font-normal">
            ...
            <p onClick={handleRemoveFromCart} className="bg-black text-white font-thin py-1 px-2 rounded-lg ml-1.5 my-0.5 cursor-pointer">Remove <i className="fi fi-rr-shopping-cart-add"></i></p>
        </div>
    )
}
